    ...
    <div>
        ...
        {stats.map((stat, index) => (
          ...
          >
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
              ...
              <div
                className={`${stat.color} w-10 h-10 sm:w-12 sm:h-12 rounded-lg opacity-20`}
              ></div>
            </div>
          </div>
        ))}
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 sm:p-6 mb-6 sm:mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
          ...
          >
            <div className="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 bg-gold bg-opacity-10 rounded-lg mr-3 sm:mr-4 flex-shrink-0">
              <svg
            ...
            <div className="min-w-0">
              <p className="font-accent font-semibold text-gray-900 dark:text-white text-sm sm:text-base">
                {t('dashboard.manageHome')}
              </p>
              <p className="font-sans text-xs sm:text-sm text-gray-600 dark:text-gray-400 truncate">
                {t('home.heroSection')}
              </p>
            </div>
          </a>
